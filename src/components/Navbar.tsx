      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <span className="relative">
            <span className="text-gradient tracking-wider">VIZORA</span>
            <span className="absolute -inset-x-4 -inset-y-2 bg-gradient-to-r from-primary/0 via-primary/20 to-primary/0 rounded-lg blur-md -z-10"></span>
            <span className="absolute inset-0 bg-gradient-to-r from-primary/0 via-primary/5 to-primary/0 rounded-sm blur-sm"></span>
          </span>
        </Link>
